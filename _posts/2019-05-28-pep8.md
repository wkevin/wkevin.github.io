...
- PEP8 是 python 官方出品的 Python 编码规范
    ...
    - 本人整理的极简版（见下文）
- [Black](https://github.com/python/black) 是 python 官方出品的、遵守PEP8的、自动代码美化工具
    - `pip install black`
    - `$black mycode.py`
- [YAPF](https://github.com/google/yapf) 是 Google 非官方出品的、可PEP8或Google内部规范、自动代码美化工具
    - `pip install yapf`
    - `$yapf mycode.py`
